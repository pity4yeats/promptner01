...
for portion in portions:
    ...
    best_model_dir = os.path.join('./saved_models', 'conll2003_{}'.format(portion), 'best_model')
...
for portion in portions:
    ...
    best_model_dir = os.path.join('./saved_models', 'conll2004_{}'.format(portion), 'best_model')
...
for portion in portions:
    ...
    model_path = os.path.join('./saved_models', 'conll2004_{}'.format(portion), 'best_model')
    model = transformers.BartForConditionalGeneration.from_pretrained(model_path)
